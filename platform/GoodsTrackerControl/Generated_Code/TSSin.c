...
byte TSSin_Configure(void)
{
  ...
  u8Result |= TSS_SetASliderConfig(TSSin_cKey0.ControlId, ASlider_Events_Register, TSS_ASLIDER_MOVEMENT_EVENT_EN_MASK | TSS_ASLIDER_INITIAL_TOUCH_EVENT_EN_MASK);
  ...
  u8Result |= TSS_SetASliderConfig(TSSin_cKey0.ControlId, ASlider_ControlConfig_Register, TSS_ASLIDER_CONTROL_EN_MASK | TSS_ASLIDER_CALLBACK_EN_MASK | 0x00);
