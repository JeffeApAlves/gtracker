...
#define configTOTAL_HEAP_SIZE                     (12101) /* size of heap in bytes */
...
/*----------------------------------------------------------*/
#define configMAX_TASK_NAME_LEN                   10 /* task name length in bytes */
...
#define configTIMER_TASK_PRIORITY                 1 /* e.g. (configMAX_PRIORITIES-1U) */
#define configTIMER_QUEUE_LENGTH                  5 /* size of queue for the timer task */
#define configTIMER_TASK_STACK_DEPTH              100 /* e.g. (configMINIMAL_STACK_SIZE) */
