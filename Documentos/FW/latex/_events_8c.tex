\hypertarget{_events_8c}{}\section{F\+:/workspace/\+Goods\+Tracker/platform/\+Goods\+Tracker\+Control/\+Sources/\+Events.c File Reference}
\label{_events_8c}\index{F\+:/workspace/\+Goods\+Tracker/platform/\+Goods\+Tracker\+Control/\+Sources/\+Events.\+c@{F\+:/workspace/\+Goods\+Tracker/platform/\+Goods\+Tracker\+Control/\+Sources/\+Events.\+c}}
...
\begin{DoxyCompactList}\small\item\em Called each second if On\+Second event is enabled (see \mbox{[}Set\+Event\+Mask\mbox{]} and \mbox{[}Get\+Event\+Mask\mbox{]} methods) and R\+TC device is enabled. This event is available only if \mbox{[}Interrupt service/event\mbox{]} is enabled. \end{DoxyCompactList}\end{DoxyCompactItemize}
