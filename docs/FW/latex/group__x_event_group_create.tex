...
\begin{DoxyPre}   // Attempt to create the event group.
   xCreatedEventGroup = \hyperlink{event__groups_8c_a2e8622ce280fff2f60ad867dff0a4519}{xEventGroupCreate()};\end{DoxyPre}
